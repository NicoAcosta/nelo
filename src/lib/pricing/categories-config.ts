...
export const CATEGORIES: CategoryConfig[] = [
    ...
    subcategories: [
      {
        ...
        items: [
          ...
          { code: "4.1.3", description: "Columnas", unit: "m3", quantityCoefficient: { baseMeasurement: "floor_area", multiplier: 0.02 }, conditions: [{ field: "structureType", operator: "equals", value: "hormigon_armado" }] },
          { code: "4.1.4", description: "Vigas principales y secundarias", unit: "m3", quantityCoefficient: { baseMeasurement: "floor_area", multiplier: 0.02 }, conditions: [{ field: "structureType", operator: "equals", value: "hormigon_armado" }] },
  ...
  // Remaining categories with simplified structure
  // Coefficients calibrated to realistic construction quantities
  ...[
    { id: "capas_aisladoras", code: "6", name: "Capas Aisladoras", nameEn: "Waterproofing & Insulation Layers", referenceIncidence: 3.11,
      unit: "m2" as const, coeff: { baseMeasurement: "floor_area" as const, multiplier: 1.0 } },
    { id: "cubierta_techo", code: "7", name: "Cubierta y Techo", nameEn: "Roofing", referenceIncidence: 2.29,
      unit: "m2" as const, coeff: { baseMeasurement: "roof_area" as const, multiplier: 1.0 } },
    { id: "revoques", code: "8", name: "Revoques", nameEn: "Plaster & Rendering", referenceIncidence: 8.84,
      unit: "m2" as const, coeff: { baseMeasurement: "wall_area" as const, multiplier: 1.0 } },
    { id: "yeseria", code: "9", name: "Yesería", nameEn: "Plasterwork", referenceIncidence: 2.57,
      unit: "m2" as const, coeff: { baseMeasurement: "wall_area" as const, multiplier: 0.5 } },
    ...
    { id: "zocalos", code: "13", name: "Zócalos", nameEn: "Baseboards", referenceIncidence: 0.36,
      unit: "ml" as const, coeff: { baseMeasurement: "perimeter" as const, multiplier: 2.0 } },
    { id: "revestimientos", code: "14", name: "Revestimientos", nameEn: "Wall Cladding", referenceIncidence: 2.45,
      unit: "m2" as const, coeff: { baseMeasurement: "bathroom_count" as const, multiplier: 12 } },
    { id: "carpinteria_metalica", code: "15", name: "Carpinterías y Herrerías Metálicas", nameEn: "Metal Joinery & Ironwork", referenceIncidence: 4.71,
      unit: "m2" as const, coeff: { baseMeasurement: "door_count" as const, multiplier: 1.68 } },
    { id: "carpinteria_aluminio", code: "16", name: "Carpintería de Aluminio", nameEn: "Aluminum Joinery", referenceIncidence: 3.20,
      unit: "m2" as const, coeff: { baseMeasurement: "window_count" as const, multiplier: 1.8 } },
    ...
    { id: "escalera", code: "18", name: "Escalera", nameEn: "Staircase", referenceIncidence: 1.61,
      unit: "m2" as const, coeff: { baseMeasurement: "stories" as const, multiplier: 5 },
      conditions: [{ field: "stories" as const, operator: "greater_than" as const, value: 1 }] },
    { id: "amoblamientos", code: "19", name: "Amoblamientos", nameEn: "Furniture & Cabinetry", referenceIncidence: 3.31,
      unit: "ml" as const, coeff: { baseMeasurement: "kitchen_count" as const, multiplier: 5 } },
    ...
    { id: "instalacion_sanitaria", code: "21", name: "Instalaciones Sanitarias", nameEn: "Plumbing & Sanitary", referenceIncidence: 6.55,
      unit: "un" as const, coeff: { baseMeasurement: "bathroom_count" as const, multiplier: 1.0 } },
    { id: "instalacion_gas", code: "22", name: "Instalación de Gas", nameEn: "Gas Installation", referenceIncidence: 3.54,
      unit: "gl" as const, coeff: { baseMeasurement: "fixed" as const, multiplier: 1 } },
    { id: "espejos", code: "23", name: "Espejos", nameEn: "Mirrors", referenceIncidence: 0.08,
      unit: "un" as const, coeff: { baseMeasurement: "bathroom_count" as const, multiplier: 1 } },
    ...
    { id: "marmoleria", code: "25", name: "Marmolería", nameEn: "Marble & Stone", referenceIncidence: 0.88,
      unit: "m2" as const, coeff: { baseMeasurement: "bathroom_count" as const, multiplier: 3 } },
    { id: "varios", code: "26", name: "Varios", nameEn: "Miscellaneous", referenceIncidence: 1.59,
      unit: "m2" as const, coeff: { baseMeasurement: "floor_area" as const, multiplier: 0.1 } },
      ...
      items: [
        {
          ...
          unit: cat.unit,
          quantityCoefficient: cat.coeff,
          referenceIncidence: cat.referenceIncidence,
          ...("conditions" in cat ? { conditions: cat.conditions } : {}),
        },
      ],
    }],
  })),
