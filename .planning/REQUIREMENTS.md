...
- [x] **PERS-03**: User sees a project list page (/projects) showing all past conversations
- [x] **PERS-04**: Projects get auto-generated titles from the first user message, editable later
