...
Plans:
- [x] 12-01-PLAN.md — Data layer: DB functions, comparison logic, server actions, tool persistence wiring (TDD)
- [x] 12-02-PLAN.md — UI: Sheet primitive, VersionHistorySheet, CostBreakdown version badge, i18n keys
...
Plans:
- [x] 13-01-PLAN.md — Data layer: share-links DB/actions, service-role client, migration, floor plan Storage upload + signed URLs (TDD)
- [x] 13-02-PLAN.md — UI: SharePopover in topbar, public /share/[token] page, i18n keys, end-to-end verification
...
| 13. Shareable Links and Floor Plan Storage | v1.1 | 2/2 | Complete   | 2026-03-22 |
